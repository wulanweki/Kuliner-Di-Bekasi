...
public class Food_Indonesia extends Activity implements OnClickListener{
	...
	private static String url_berita = "http://sutiakuliner.besaba.com/kuliner/lokoandro/indonesia.php";
	...
	class AmbilDataKuliner extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(Food_Indonesia.this);
	...
	public void onClick(View arg0) {
		...
		switch (arg0.getId()) {
		case R.id.back:
			Food_Indonesia.this.finish();
		break;
		case R.id.refresh:
        	finish();
        	startActivity(getIntent());
            Toast.makeText(Food_Indonesia.this, "Update Informasi Kuliner", Toast.LENGTH_SHORT).show();            
		break;
		}
	}    	
}
