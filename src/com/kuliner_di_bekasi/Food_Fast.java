...
public class Food_Fast extends Activity implements OnClickListener{

	private ProgressDialog pDialog;
	JSONParser jParser = new JSONParser();
	ArrayList<HashMap<String, String>> 
	DaftarKuliner = new ArrayList<HashMap<String, String>>();
	private static String url_berita = "http://sutiakuliner.besaba.com/kuliner/lokoandro/Fastfood.php";
	...
	class AmbilDataKuliner extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(Food_Fast.this);
	...
	public void onClick(View arg0) {
		...
		switch (arg0.getId()) {
		case R.id.back:
			Food_Fast.this.finish();
		break;
		case R.id.refresh:
        	finish();
        	startActivity(getIntent());
            Toast.makeText(Food_Fast.this, "Update Informasi Kuliner", Toast.LENGTH_SHORT).show();            
		break;
		}
	}    	
}
