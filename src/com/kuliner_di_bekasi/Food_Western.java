...
public class Food_Western extends Activity implements OnClickListener{
	...
	private static String url_berita = "http://sutiakuliner.besaba.com/kuliner/lokoandro/western.php";
	...
	class AmbilDataKuliner extends AsyncTask<String, String, String> {
		...
		protected void onPreExecute() {
			super.onPreExecute();
			pDialog = new ProgressDialog(Food_Western.this);
	...
	public void onClick(View arg0) {
		...
		switch (arg0.getId()) {
		case R.id.back:
			Food_Western.this.finish();
		break;
		case R.id.refresh:
        	finish();
        	startActivity(getIntent());
            Toast.makeText(Food_Western.this, "Update Informasi Kuliner", Toast.LENGTH_SHORT).show();            
		break;
		}
	}    	
}
